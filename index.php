...
<body>
	...
	<main>
		<section class="container-fluid container-md first-section row wrap ">
			<header class="col-sm-12 col-md-6 pad-le_35">
				<h1 class="uppercase f-white main-title compressed medium">Prensa-cabos metálicos</h1>
			</header>
			
			<p class="col-sm-12 col-md-6 pad-le_35 pad-top_15 f-white flex">
			...
			<figure class="col-sm-12 col-md-6 flex center al-start">
